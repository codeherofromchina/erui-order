...
public enum LogisticsDataStatusEnum {
    ...
    LogisticsDataStatusEnum(int code, String name) {
     ...
     * @return
     */
    public static LogisticsDataStatusEnum valueOf(Short code) {
        if (code != null) {
            short code02 = code.shortValue(); // 拆箱一次
            for (LogisticsDataStatusEnum statusEnum : LogisticsDataStatusEnum.values()) {
