...
CREATE TABLE order_test.attachment (
    ...
    target_obj_table VARCHAR(255) COMMENT '附件所属业务',
...
CREATE TABLE `order` (
    ...
    order_source SMALLINT DEFAULT 3 COMMENT '订单来源 订单来源 1门户订单 2门户询单 3线下订单',
    `project_no` varchar(50) DEFAULT NULL COMMENT '项目号',
    signing_date DATE  COMMENT '订单签约日期 TODO',
    ...
    order_belongs SMALLINT NULL COMMENT '订单所属 TODO',
    ...
    advance_money DECIMAL(20 , 4 ) NULL COMMENT '预收金额 TODO',
    create_user_id BIGINT NULL COMMENT '创建人',
    create_time DATETIME NOT NULL DEFAULT NOW() COMMENT '创建时间',
    update_user_id BIGINT NULL COMMENT '更新人',
...
CREATE TABLE order_test.project (
    ...
    deliver_consign_has BIT COMMENT '是否已生成出口通知单',
    quality_inspect_type CHAR(4) COMMENT '质量检验类型 TODO',
    create_user_id BIGINT NULL COMMENT '创建人',
    create_time DATETIME NOT NULL DEFAULT NOW() COMMENT '创建时间',
    update_user_id BIGINT NULL COMMENT '更新人',
    update_time DATETIME NULL DEFAULT NULL COMMENT '记录更新时间',
...
CREATE TABLE deliver_detail_goods (
    ...
    detail_goods_remarks VARCHAR(255) NULL COMMENT '备注',
    create_user_id bigint null comment '创建人',
    create_time datetime not null default now() comment '创建时间',
    update_user_id bigint null comment '更新人',
    update_time datetime null default null comment '记录更新时间',
...
CREATE TABLE `logistics_data` (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '主键',
    deliver_detail_id BIGINT COMMENT '出库单详情ID',
    the_awb_no varchar(255) COMMENT '运单号',
    contract_no CHAR(15) COMMENT '销售合同号',
...
CREATE TABLE `supplier` (
  ...
  `line_of_credit` decimal(20,4) DEFAULT NULL COMMENT '授信额度 TODO',
  `credit_available` decimal(20,4) DEFAULT NULL COMMENT '可用额度 TODO',
